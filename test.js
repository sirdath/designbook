...
test('tool surface + gate constants are single-sourced and stable', () => {
  assert.equal(TOOLS.length, 28, 'all 28 tools enumerated');
  for (const t of ['book_overview', 'book_compose', 'book_variants', 'book_autofill_imagery', 'book_inspect', 'book_save_page', 'book_export_pptx', 'book_lottie', 'book_video_diagnose', 'book_video_frames']) {
