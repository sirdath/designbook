...
export const MODES = ['layout', 'perf', 'diagnose', 'element', 'mobile'];
...
export async function inspect({ html, vaultRoot, bookDir, viewports, screenshot, fullPage, shotsDir, label, mode, selector }) {
  ...
  let probe = { layout: PROBE, perf: PERF_PROBE, diagnose: DIAGNOSE_PROBE, element: ELEMENT_PROBE, mobile: MOBILE_PROBE }[m];
