...
(function () {
  ...
  function run() {
    ...
    var R = {
      ...
      layout: { hOverflow: (document.scrollingElement || document.documentElement).scrollWidth > W + 1, overflowers: [], smallTaps: [], tinyText: [], overlaps: [], occluded: [] },
    ...
    penalty += (R.layout.hOverflow ? 10 : 0) + R.layout.overflowers.length * 3 + R.layout.overlaps.length * 4 + R.layout.tinyText.length * 2 + R.layout.occluded.length * 8;
    ...
    R.summary = { errors: errs, contrastFails: R.a11y.contrastFails.length, invisibleContent: R.render.invisibleContent.length, layoutIssues: (R.layout.hOverflow ? 1 : 0) + R.layout.overflowers.length + R.layout.overlaps.length + R.layout.occluded.length, score: R.score };
