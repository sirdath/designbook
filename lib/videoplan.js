...
export const SCENES = {
  ...
  UIDemo:            { dur: 150, range: [120, 180], role: 'body',  defaults: { headline: 'Create a report', query: 'Active users', options: ['Revenue', 'Active users', 'Churn rate'], selectIndex: 1, buttonLabel: 'Create report' } },
...
export const GENRE_SEQUENCES = {
  saas:       ['TitleCard', 'FeatureCard', 'UIDemo', 'StatBurst', 'FeatureCard', 'CTACard'],
...
export function composeVideoPlan(opts = {}) {
  ...
  return {
    ...
    audio: opts.audio || null, // { music:{src,volume}, voiceover:{src,volume} } — agent-attached
    captions: opts.captions || null, // [{text,fromFrame,toFrame}] — agent-provided or from whisper
  };
}
